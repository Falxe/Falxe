...
function prison_life()
    local Window = Library.CreateLib("Falxe's Prison Life", 'Ocean')
...
function MM2()
    ...
    PlayerSection:NewButton('Xray [L]', 'Gives you xray (see through walls).', function()
        local xrayHotkey = Enum.KeyCode.L
